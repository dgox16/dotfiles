...
elseif vim.g.colors_name == "catppuccin-mocha" then
    ...
    local colors = {
        ...
        subtext2 = mocha.subtext0,
        subtext3 = mocha.overlay2,
        subtext4 = mocha.overlay1,
        ...
        blue = mocha.blue,
        cyan = mocha.teal,
        gray0 = mocha.surface2,
        gray1 = mocha.surface1,
        gray2 = mocha.surface0,
        gray3 = mocha.surface0,
        gray4 = mocha.surface0,
    }
    config_lualine(colors)
end
